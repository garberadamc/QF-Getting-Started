...
9.  Introduce the "mplusObject Method"
...
write_csv(exp_data, here("data", "exp_data.csv"))
...
nolabel_data <- read_csv(here("data", "exp_data.csv"))
...
prepareMplusData(nolabel_data, here("data", "exp_data.dat"))
...
m_basic_fit <- mplusModeler(m_basic, 
               dataout=here("mplus_files", "basic.dat"),
               modelout=here("mplus_files", "basic.inp"),
               check=TRUE, run = TRUE, hashfilename = FALSE)
